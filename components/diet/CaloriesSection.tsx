      ...
      <div className="mb-4 sm:mb-6">
        <div className="bg-gray-700 rounded-lg p-3 sm:p-4">
          <div className="flex items-center justify-between mb-2">
            ...
            <span className="text-white font-semibold">{goalCalories} cal</span>
          </div>
        ...
        {dailyData.foodEntries.length > 0 && (
          <div className="mt-2 sm:mt-3 space-y-2">
            {dailyData.foodEntries.map((entry) => (
              <div
                key={entry.id}
                className="bg-gray-700 rounded-lg p-2.5 sm:p-3 flex items-center justify-between"
              >
                <div>
                  <div className="text-white font-medium">{entry.name}</div>
                  <div className="text-gray-400 text-sm">{entry.quantity}</div>
                </div>
